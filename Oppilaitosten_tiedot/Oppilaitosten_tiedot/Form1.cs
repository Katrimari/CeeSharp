...
{
    public partial class OPtiedotFM : Form
    {
        ...
        private void VastuuhloCB_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            PuhLB.Text = yhteys.Rows[VastuuhloCB.SelectedIndex]["VPuh"].ToString();
        }

        private void OPtiedotFM_Load(object sender, EventArgs e)
        {
            taytaOPtaulukko();
        ...
        private void taytaVHtaulukko()
        {
            ...
            vastuuHenkilot.Columns.Add("VPuh");
